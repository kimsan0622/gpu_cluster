...
if [ "${UBUNTU_VER}" == "14.04" ]; then
    #14.04
    wget http://developer.download.nvidia.com/compute/cuda/repos/ubuntu1404/x86_64/cuda-repo-ubuntu1404_10.1.168-1_amd64.deb
    dpkg -i cuda-repo-ubuntu1404_10.1.168-1_amd64.deb
    apt-key adv --fetch-keys http://developer.download.nvidia.com/compute/cuda/repos/ubuntu1404/x86_64/7fa2af80.pub
    apt-get update
    apt-get install -y cuda
    rm -rf cuda-repo-ubuntu1404_10.1.168-1_amd64.deb
    ...
    sudo apt-get update
    apt-get install -y cuda
    rm -rf cuda-repo-ubuntu1604_10.1.168-1_amd64.deb
    ...
    sudo apt-get update
    apt-get install -y cuda
    rm -rf cuda-repo-ubuntu1804_10.1.168-1_amd64.deb
    ...
    sudo apt-get update
    apt-get install -y cuda
    rm -rf cuda-repo-ubuntu1810_10.1.168-1_amd64.deb
fi